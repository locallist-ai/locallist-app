export default {
  ...
  import: {
    ...
    permissionDeniedBody: 'Permite el acceso a la fototeca en Ajustes para elegir un vídeo.',
    ...
    errorTooLarge: 'El vídeo es demasiado grande. Debe pesar menos de 150 MB.',
    errorTooLong: 'El vídeo es demasiado largo. Debe durar 10 minutos o menos.',
    errorUnsupported: 'Ese formato no es compatible. Usa un vídeo MP4, MOV o WebM.',
